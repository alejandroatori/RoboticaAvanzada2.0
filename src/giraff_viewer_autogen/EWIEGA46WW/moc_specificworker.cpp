...
QT_MOC_LITERAL(7, 72, 19), // "new_tilt_value_slot"
QT_MOC_LITERAL(8, 92, 17), // "sweep_button_slot"
QT_MOC_LITERAL(9, 110, 17) // "trace_button_slot"

    },
    "SpecificWorker\0compute\0\0startup_check\0"
    "initialize\0period\0new_target_slot\0"
    "new_tilt_value_slot\0sweep_button_slot\0"
    "trace_button_slot"
};
...
void SpecificWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->new_tilt_value_slot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->sweep_button_slot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->trace_button_slot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
